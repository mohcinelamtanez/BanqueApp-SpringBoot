...
// Resolves to the id of whichever Client the currently logged-in
// CLIENT-role user is linked to (set by AuthController at login). A
// function, not a constant, so it always reflects whoever is actually
// authenticated right now rather than a fixed stand-in.
export function getCurrentClientId() {
  return getUser()?.clientId ?? null;
}
